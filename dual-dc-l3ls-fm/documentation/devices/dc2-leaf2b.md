...
| Ethernet8 | DC2-LEAF2-HOST_Ethernet2 | *trunk | *11-12,21-22,3401-3402 | *- | *- | 8 |
...
!
interface Ethernet8
   description DC2-LEAF2-HOST_Ethernet2
   no shutdown
...
| Port-Channel8 | DC2-LEAF2-HOST_Po1 | switched | trunk | 11-12,21-22,3401-3402 | - | - | - | - | 8 | - |
...
interface Port-Channel8
   description DC2-LEAF2-HOST_Po1
   no shutdown
   switchport
