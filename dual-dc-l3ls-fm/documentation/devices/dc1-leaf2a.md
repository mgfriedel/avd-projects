...
| Ethernet8 | DC1-LEAF2-L2SW_Ethernet1 | *trunk | *101-102,111-112,201-202,211-212,3401-3402 | *- | *- | 8 |
...
!
interface Ethernet8
   description DC1-LEAF2-L2SW_Ethernet1
   no shutdown
...
| Loopback10 | Prod1_VTEP_DIAGNOSTICS | Prod1 | 10.255.12.5/32 |
| Loopback11 | Prod2_VTEP_DIAGNOSTICS | Prod2 | 10.255.13.5/32 |
| Loopback20 | HA1_VTEP_DIAGNOSTICS | HA1 | 10.255.14.5/32 |
| Loopback21 | HA2_VTEP_DIAGNOSTICS | HA2 | 10.255.15.5/32 |
...
| Vlan3009 |  Prod1  |  10.255.1.100/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Prod2  |  10.255.1.100/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  HA1  |  10.255.1.100/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3020 |  HA2  |  10.255.1.100/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.1.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | HA1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | HA2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Prod1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Prod2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 101 | 10.255.0.5:10101 | 10101:10101<br>remote 10101:10101 | - | - | learned |
| 102 | 10.255.0.5:10102 | 10102:10102<br>remote 10102:10102 | - | - | learned |
| 111 | 10.255.0.5:10111 | 10111:10111<br>remote 10111:10111 | - | - | learned |
| 112 | 10.255.0.5:10112 | 10112:10112<br>remote 10112:10112 | - | - | learned |
| 201 | 10.255.0.5:20201 | 20201:20201<br>remote 20201:20201 | - | - | learned |
| 202 | 10.255.0.5:20202 | 20202:20202<br>remote 20202:20202 | - | - | learned |
| 211 | 10.255.0.5:20211 | 20211:20211<br>remote 20211:20211 | - | - | learned |
| 212 | 10.255.0.5:20212 | 20212:20212<br>remote 20212:20212 | - | - | learned |
| 3401 | 10.255.0.5:23401 | 23401:23401<br>remote 23401:23401 | - | - | learned |
| 3402 | 10.255.0.5:23402 | 23402:23402<br>remote 23402:23402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| HA1 | 10.255.0.5:20 | connected |
| HA2 | 10.255.0.5:21 | connected |
| Prod1 | 10.255.0.5:10 | connected |
| Prod2 | 10.255.0.5:11 | connected |
...
router bgp 65102
   ...
   vlan 101
      rd 10.255.0.5:10101
      rd evpn domain remote 10.255.0.5:10101
   ...
   vlan 102
      rd 10.255.0.5:10102
      rd evpn domain remote 10.255.0.5:10102
   ...
   vlan 111
      rd 10.255.0.5:10111
      rd evpn domain remote 10.255.0.5:10111
   ...
   vlan 112
      rd 10.255.0.5:10112
      rd evpn domain remote 10.255.0.5:10112
   ...
   vlan 201
      rd 10.255.0.5:20201
      rd evpn domain remote 10.255.0.5:20201
   ...
   vlan 202
      rd 10.255.0.5:20202
      rd evpn domain remote 10.255.0.5:20202
   ...
   vlan 211
      rd 10.255.0.5:20211
      rd evpn domain remote 10.255.0.5:20211
   ...
   vlan 212
      rd 10.255.0.5:20212
      rd evpn domain remote 10.255.0.5:20212
   ...
   vlan 3401
      rd 10.255.0.5:23401
      rd evpn domain remote 10.255.0.5:23401
   ...
   vlan 3402
      rd 10.255.0.5:23402
      rd evpn domain remote 10.255.0.5:23402
...
```eos
!
ip address virtual source-nat vrf HA1 address 10.255.14.5
ip address virtual source-nat vrf HA2 address 10.255.15.5
ip address virtual source-nat vrf Prod1 address 10.255.12.5
ip address virtual source-nat vrf Prod2 address 10.255.13.5
```
