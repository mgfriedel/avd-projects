...
| Ethernet5 | P2P_LINK_TO_DC1-DCILEAF1_Ethernet1 | routed | - | 10.255.255.16/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_DC1-DCILEAF2_Ethernet1 | routed | - | 10.255.255.20/31 | default | 1500 | False | - | - |
...
!
interface Ethernet5
   description P2P_LINK_TO_DC1-DCILEAF1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_DC1-DCILEAF2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65100
   ...
   neighbor 10.255.255.17 description dc1-dcileaf1_Ethernet1
   neighbor 10.255.255.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.21 remote-as 65111
   neighbor 10.255.255.21 description dc1-dcileaf2_Ethernet1
