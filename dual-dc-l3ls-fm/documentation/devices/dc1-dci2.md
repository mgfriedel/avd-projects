...
| --------- | --------------- | ------------ | --------- |
| DC1_DCI | Vlan4094 | 10.255.1.72 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_dc1-dci1_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_dc1-dci1_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
!
interface Ethernet3
   description MLAG_PEER_dc1-dci1_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_dc1-dci1_Ethernet4
   no shutdown
   channel-group 3 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_dc1-dci1_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_dc1-dci1_Po3
   no shutdown
   switchport
...
| Loopback10 | Prod1_VTEP_DIAGNOSTICS | Prod1 | 10.255.12.8/32 |
| Loopback11 | Prod2_VTEP_DIAGNOSTICS | Prod2 | 10.255.13.8/32 |
| Loopback20 | HA1_VTEP_DIAGNOSTICS | HA1 | 10.255.14.8/32 |
| Loopback21 | HA2_VTEP_DIAGNOSTICS | HA2 | 10.255.15.8/32 |
...
interface Loopback20
   ...
   no shutdown
   vrf HA1
   ip address 10.255.14.8/32
!
interface Loopback21
   description HA2_VTEP_DIAGNOSTICS
   no shutdown
   vrf HA2
   ip address 10.255.15.8/32
```
...
| Vlan3009 |  Prod1  |  10.255.1.105/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Prod2  |  10.255.1.105/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  HA1  |  10.255.1.105/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3020 |  HA2  |  10.255.1.105/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.1.104 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | HA1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.104 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | HA2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.104 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Prod1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.104 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Prod2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 101 | 10.255.0.8:10101 | 10101:10101 | - | - | learned |
| 102 | 10.255.0.8:10102 | 10102:10102 | - | - | learned |
| 111 | 10.255.0.8:10111 | 10111:10111 | - | - | learned |
| 112 | 10.255.0.8:10112 | 10112:10112 | - | - | learned |
| 201 | 10.255.0.8:20201 | 20201:20201 | - | - | learned |
| 202 | 10.255.0.8:20202 | 20202:20202 | - | - | learned |
| 211 | 10.255.0.8:20211 | 20211:20211 | - | - | learned |
| 212 | 10.255.0.8:20212 | 20212:20212 | - | - | learned |
| 3401 | 10.255.0.8:23401 | 23401:23401 | - | - | learned |
| 3402 | 10.255.0.8:23402 | 23402:23402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| HA1 | 10.255.0.8:20 | connected |
| HA2 | 10.255.0.8:21 | connected |
| Prod1 | 10.255.0.8:10 | connected |
| Prod2 | 10.255.0.8:11 | connected |
...
router bgp 65111
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-dci1
   ...
   neighbor 10.255.1.104 description dc1-dci1
...
```eos
!
ip address virtual source-nat vrf HA1 address 10.255.14.8
ip address virtual source-nat vrf HA2 address 10.255.15.8
ip address virtual source-nat vrf Prod1 address 10.255.12.8
ip address virtual source-nat vrf Prod2 address 10.255.13.8
```
